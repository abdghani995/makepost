...
<div class="container">
  ...
  <table  height="80" border="0" align="center" cellspacing="0" cellpadding="5" class="well">
    <tr>
		<td colspan="6" align="center"><h3>NUMBER OF RECORDS PER PAGE :-- </h3></td>
        <td width="1000px"><input type="text" name="num" onChange="javascript:submit()" value=<?php if(isset($num))echo $num; ?>></td>
	</tr>
	<tr>
      <td width="500px" align="center"><h4>ID</h4></td>
      <td width="300" align="center"><h4>NAME </h4></td>
      <td width="300" align="center"><h4>EMAIL ID </h4></td>
      <td align="center"><h4>USERNAME </h4></td>
    ...
    <tr>
	  ...
	  <td align="center"><a href="del.php?id=<?php echo $obj->encr($arr[0]);?>&page=<?php echo $page?>"><img src="images/T_Delete_Lg_D.png"></a></td>
	   <td align="center"><a href="edit.php?id=<?php echo $obj->encr($arr[0]); ?>"><img src="images/b_edit.png"></a></td>
    </tr>
	<?php }}?>
	<tr>
